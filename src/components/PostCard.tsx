...
import { PostCardProps } from "@/app/types/blog";
...
//   description: string;
//   link: string;
//   maxWidth?: { xs: number | string; lg: number | string };
// }
  ...
  return (
    ...
    >
      <Box sx={{ display: { xs: "none", lg: "block" }, position: 'relative' }}>
        <PostLink href={`/blogs/${link.replace(/^\//, "")}`}>
          <Image
      ...
      <CardContent sx={{ pt: 3, px: 1, pb: 1, flexGrow: 1 }}>
      ...
      <CardActions sx={{ p: 0, pl: 1, pb: 2, flexWrap: "wrap", gap: 1 }}>
